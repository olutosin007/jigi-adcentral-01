      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center">
            <span className="text-background font-serif font-bold text-lg">J</span>
          </div>
          <span className="font-serif text-xl tracking-wide">Jigi</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-5 py-2.5 rounded-full bg-white text-background text-sm font-medium hover:bg-white/90 transition-colors">
            Start Free
          </button>
        </div>
      </div>
...
const HERO_IMAGES = [
  ...
  {
    url: "https://images.unsplash.com/photo-1603584173870-7f23fdae1b7a?q=80&w=2564&auto=format&fit=crop",
    alt: "Automotive Advertising Creative"
  },
  {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-background/40 bg-gradient-to-t from-background/50 via-background/20 to-background/40" />
      </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            <span className="text-gradient">Pure Imagination,</span><br />
          ...
          >
            Generate production-ready creative from a single text prompt. 
            Route it through structured review, and ship approved assets without the workflow chaos.
          </motion.p>
          ...
          >
            <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-background font-medium hover:bg-white/90 transition-all flex items-center justify-center gap-2 group">
              Start Creating
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-lg text-white/60 font-light">
            Off-brand outputs, feedback scattered across Slack, and approval bottlenecks. 
            We rebuilt the pipeline from the ground up.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-20">
          <h2 className="text-4xl md:text-6xl font-serif mb-6 max-w-2xl">
            Everything required to ship <span className="italic text-white/70">on-brand</span> creative.
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 glass-panel rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-12 group">
            <div className="flex-1">
              ...
              <p className="text-white/60 font-light leading-relaxed mb-8">
                Upload your brand assets, define your voice, and set visual rules. 
                Jigi ensures every generated concept strictly adheres to your constraints from day one.
              </p>
              <ul className="space-y-3">
                {['Custom color palettes', 'Typography enforcement', 'Tone of voice matching'].map((item, i) => (
          ...
          {[
            ...
            <div key={i} className="glass-panel rounded-3xl p-8 hover:bg-white/[0.04] transition-colors">
    ...
    <section id="results" className="py-32 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-white/10 border-y border-white/10 py-12">
          {[
            { metric: "73%", label: "Faster approval turnaround", context: "From 5 days to under 24 hours" },
            { metric: "4x", label: "Fewer feedback loops", context: "Due to brand-grounded generation" },
            { metric: "2.5x", label: "More assets shipped", context: "Per campaign, without adding headcount" }
          ].map((stat, i) => (
            <div key={i} className="px-8 py-6 md:py-0 text-center flex flex-col items-center justify-center">
              <div className="text-6xl font-serif font-light text-gradient-accent mb-4">{stat.metric}</div>
    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="px-8 py-4 rounded-full bg-white text-background font-medium hover:bg-white/90 transition-all flex items-center justify-center gap-2">
            Start Free
          </button>
        ...
        <p className="mt-6 text-xs text-white/40 uppercase tracking-widest">Exclusive access for agency partners</p>
      </div>
    </section>
  );
};
    ...
    <footer className="border-t border-white/10 bg-background pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center">
                <span className="text-background font-serif font-bold text-sm">J</span>
              </div>
              <span className="font-serif text-lg tracking-wide">Jigi</span>
            </div>
          ...
          <div>
            <h4 className="text-sm font-medium mb-6 uppercase tracking-wider text-white/80">Product</h4>
          ...
          <div>
            <h4 className="text-sm font-medium mb-6 uppercase tracking-wider text-white/80">Resources</h4>
            <ul className="space-y-4 text-sm text-white/50">
          ...
          <div>
            <h4 className="text-sm font-medium mb-6 uppercase tracking-wider text-white/80">Company</h4>
            <ul className="space-y-4 text-sm text-white/50">
...
export default function App() {
  return (
    <div className="min-h-screen bg-background text-white selection:bg-[#D4AF37]/30">
      <Navbar />
      <main>
        <Hero />
        <Logos />
