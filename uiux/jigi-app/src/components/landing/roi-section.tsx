          ...
          {comparisons.map((c) => (
            ...
            >
              ...
              <div className="mt-5 flex items-center gap-3">
                <div className="flex-1 rounded-lg bg-destructive/10 px-4 py-3 text-center dark:bg-destructive/20">
                  <span className="text-sm font-semibold text-destructive">{c.before}</span>
                </div>
                <ArrowRight className="size-4 shrink-0 text-primary" />
                <div className="flex-1 rounded-lg bg-primary/10 px-4 py-3 text-center dark:bg-primary/20">
                  <span className="text-sm font-semibold text-primary">{c.after}</span>
                </div>
              </div>
